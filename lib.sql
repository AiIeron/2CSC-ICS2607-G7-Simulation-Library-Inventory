...
CREATE TABLE STUDENT (
    STU_ID_NUM CHAR(10) NOT NULL PRIMARY KEY,
    STU_FNAME VARCHAR(50) NOT NULL,
    STU_LNAME VARCHAR(50) NOT NULL,
    STU_PHONE_NUM CHAR(11),
...
CREATE TABLE GENRE (
    GENRE_ID CHAR(3) NOT NULL PRIMARY KEY,
    GENRE_NAME VARCHAR(50) UNIQUE NOT NULL,
    GENRE_DESC VARCHAR(100) NOT NULL
);

CREATE TABLE AUTHOR (
    AUTH_ID CHAR(5) NOT NULL PRIMARY KEY,
...
CREATE TABLE BOOK (
    ...
    -- REMOVED GENRE_ID CHAR(3) NOT NULL,
    CHECK (BOOK_AGE_RATING BETWEEN 1 AND 99),
    FOREIGN KEY (PUB_ID) REFERENCES PUBLISHER(PUB_ID)
    -- REMOVED FOREIGN KEY (GENRE_ID) REFERENCES GENRE(GENRE_ID)
);
